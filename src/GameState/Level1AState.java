...
public class Level1AState extends GameState {
	...
	public void init() {
		...
		// sfx
		Music.load("/SFX/teleport.mp3", "teleport");
		Music.load("/SFX/explode.mp3", "explode");
		Music.load("/SFX/enemyhit.mp3", "enemyhit");
		
		// music
		Music.load("/Music/level1.mp3", "level1");
		Music.loop("level1", 600, Music.getFrames("level1") - 2200);
