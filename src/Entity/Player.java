...
public class Player extends MapObject {
	...
	public Player(TileMap tm) {
		...
		Music.load("/SFX/playerjump.mp3", "playerjump");
		Music.load("/SFX/playerlands.mp3", "playerlands");
		Music.load("/SFX/playerattack.mp3", "playerattack");
		Music.load("/SFX/playerhit.mp3", "playerhit");
		Music.load("/SFX/playercharge.mp3", "playercharge");
